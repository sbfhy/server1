                                        ...
                                        const google::protobuf::Message& message)
{
  ...
  assert(buf->readableBytes() == byte_size); (void) byte_size;
...
void ProtobufCodecLite::defaultErrorCallback(const TcpConnectionPtr& conn,
                                             ...
                                             ErrorCode errorCode)
{
  LOG_ERROR << "ProtobufCodecLite::defaultErrorCallback - " << errorCodeToString(errorCode) << ", " << buf->toStringPiece();
                                                      ...
                                                      ::google::protobuf::Message* message)
{
  ...
  if (!parseFromBuffer(StringPiece(buf, len), message))
  {
    error = kParseError;
  }
